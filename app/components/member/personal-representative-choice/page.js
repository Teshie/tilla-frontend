...
const PersonalOrRepresentative = () => {
  return (
    <div className="flex flex-col space-y-8 justify-center items-center p-4">
      <p className="text-lg font-semibold">Are you registering for yourself?</p>

      <div className="flex justify-center space-x-8 items-center">
        <Link href="/components/member/diaspora_self_registration">
        ...
        <Link href="/components/member/diaspora_representative_registration">
